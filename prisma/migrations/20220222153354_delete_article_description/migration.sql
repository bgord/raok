...
INSERT INTO "new_Article" ("createdAt", "favourite", "favouritedAt", "id", "image", "newspaperId", "source", "status", "title", "url") SELECT "createdAt", "favourite", "favouritedAt", "id", "image", "newspaperId", "source", "status", "title", "url" FROM "Article";
DROP TABLE "Article";
